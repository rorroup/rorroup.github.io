...
function animation_animationRun(timeNow)
{
...
function animation_animationStart(timeNow)
{
...
function animation_initAnimationComponent(animationComponent, animationFunction, animationArguments = false, animationShouldStart = true)
{	
